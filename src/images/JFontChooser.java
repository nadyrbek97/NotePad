...
/**
 * The JFontChooser class is a swing component
 * for font selection.
 **/
public class JFontChooser extends JComponent
{
    /**
     * Return the 'Ok' value from showDialog()
     **/
    public static final int OK_OPTION = 0;
    /**
     * Return the 'Cancel' value from showDialog()
     **/
    public static final int CANCEL_OPTION = 1;
    /**
     * Return the 'Error' value from showDialog()
     **/
    ...
    private class DialogOKAction extends AbstractAction
    {
        ...
        private DialogOKAction(JDialog dialog)
        {
            this.dialog = dialog;
    ...
    private class DialogCancelAction extends AbstractAction
    {
        ...
        private DialogCancelAction(JDialog dialog)
        {
            this.dialog = dialog;
            putValue(Action.DEFAULT, ACTION_NAME);
            putValue(Action.ACTION_COMMAND_KEY, ACTION_NAME);
    ...
    private JTextField getSampleTextField()
    {
        if (sampleText == null)
        {
            ...
            sampleText = new JTextField(("AaBbYyZz Nadyrbek"));
